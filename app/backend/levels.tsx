const backendExperience = [
  ...
  {
    salary: "30 000 000",
    level: "Senior", // "Sunior" deb xato yozilgandi, to'g'riladim
    exp: "3+ yil",
    marginTop: "mt-0",
...
export default function BackendExperienceSection() {
  return (
    <div className="px-64 py-14 max-md:px-5">
      ...
      <div className="flex gap-2 items-center text-sm text-gray-400 mt-16 font-bold">
        ...
        <p>
          hh.uz ma'lumotlariga ko'ra, Web Backend mutaxassisi
          <br />
