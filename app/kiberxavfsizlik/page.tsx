      ...
      <div>
        <div className="flex pl-56 pr-24 justify-between bg-blue-50 pb-20 w-full h-full max-md:pl-5 max-md:pr-7">
          <div className="mt-36">
            ...
            <h1 className="mt-16">
              ...
              himoya qilish jarayoni. Internetda xakerlar, zararli dasturlar va
              firibgarlar odamlarning <br />
              shaxsiy ma’lumotlarini o‘g‘irlash yoki tizimlarni buzishga harakat
              qilishadi. Bunga yo‘l <br />
              qo‘ymaslik uchun kuchli parollar ishlatish, dasturlarni yangilab
              turish va antivirus kabi <br />
              xavfsizlik vositalaridan foydalanish muhim. Agar kiberxavfsizlikka
              e’tibor berilmasa, <br />
        ...
        <div className="pl-64 pr-24 mt-28 max-md:pl-5 max-md:pr-7">
          ...
          <h1 className="text-xl font-semibold mt-8">
            ...
            kasb doimiy ravishda o‘rganishni, yechim izlashni va texnologiyalar
            bilan ishlashni talab qiladi. Agar sen IT va <br />
            xavfsizlikga qiziqsang, bu juda qiziqarli va talabgir kasb bo‘lishi
            mumkin!
          </h1>
          <Image
            data-aos="zoom-in"
