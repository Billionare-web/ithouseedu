...
const courseDetails = [
  ...
  {
    image: Boy,
    title: "Bilimlarni tizimlashtirish va Pythonni o'z kasbingiz qiling",
    points: [
      "Asosiy bilimlaringizni chuqurlashtiring",
      "Python dasturlash, algoritmlar va ma’lumotlar tahlil mahoratingizni oshiring.",
...
export default function CourseTarget() {
  return (
    <div className="px-64 mt-10 max-md:px-5">
      ...
      <h1 className="mt-8">
        Biz Python dasturlashni shu narsalarni istagan o'quvchilar uchun qildik
      </h1>
      <div className="flex justify-between mt-7 gap-5 flex-col">
        {courseDetails.map((course, index) => (
          ...
          >
            ...
            {course.points.map((point, i) => (
              <h1 key={i} className="flex mt-6 gap-2">
                <FaCheck />
                {point}
              </h1>
            ))}
