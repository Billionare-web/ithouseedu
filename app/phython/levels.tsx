const pythonDeveloperExperience = [
  {
    salary: "4 000 000",
    level: "Junior",
    exp: "1 yilgacha",
...
export default function PythonDeveloperExperienceSection() {
  return (
    <div className="px-64 py-14 max-md:px-5">
      ...
      <div className="flex gap-2 items-center text-sm text-gray-400 mt-16 font-bold">
        ...
        <p>
          hh.uz ma'lumotlariga ko'ra, Phyton dasturchisining
          <br />
      ...
      <div className="flex gap-3 mt-10 max-md:flex-col">
        {pythonDeveloperExperience.map((item, i) => (
          <div
            key={i}
            data-aos="fade-up"
