      ...
      <div>
        ...
        <div className="">
          <div className="flex pl-56 pr-24 justify-between bg-blue-50 pb-20 w-full h-wull">
            <div className="mt-36">
              <h1 className="text-5xl font-bold">AI, Suniy Intellekt</h1>
              ...
              <h1 className="mt-16">
                ...
                beradi: siz AI <br />
                startaplarida, IT kompaniyalarda yoki tadqiqot markazlarida
                ishga joylashishingiz <br />
            ...
            <Image
              ...
              className="w-[600px] h-[600px] mt-20"
              src={AIai}
              alt=""
            />
          </div>
