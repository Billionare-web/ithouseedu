const computerLiteracyExperience = [
  {
    salary: "3 000 000",
    level: "Junior",
    exp: "1 yilgacha",
...
export default function ComputerLiteracyExperienceSection() {
  return (
    <div className="px-64 py-14 max-md:px-5">
      ...
      <div className="flex gap-2 items-center text-sm text-gray-400 mt-16 font-bold">
        ...
        <p>
          hh.uz ma'lumotlariga ko'ra, Kompyuter savodxonligi mutaxassisi
          <br />
          o'rtacha ish haqi 6 500 000 so‘mni tashkil qiladi
        </p>
      </div>

      <div className="flex gap-3 mt-10 max-md:flex-col">
        {computerLiteracyExperience.map((item, i) => (
          <div
            key={i}
            data-aos="fade-up"
